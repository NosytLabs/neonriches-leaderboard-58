  ...
  return (
    <section className="w-full min-h-[90vh] pt-32 pb-20 relative overflow-hidden throne-bg">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-1/3 -right-1/4 w-96 h-96 rounded-full bg-royal-blue/20 filter blur-[100px] animate-pulse-slow" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-3/4 left-1/3 w-72 h-72 rounded-full bg-royal-gold/20 filter blur-[100px] animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-royal tracking-tighter mb-6">
            ...
            <span className="block royal-gradient">SpendThrone</span>
          </h1>
