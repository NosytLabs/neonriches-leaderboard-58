...
const RoyalParchment: React.FC<RoyalParchmentProps> = ({
  ...
  return (
    <Card className={cn(
      ...
      {/* Optional wax seal */}
      {waxSeal && (
        <div className="absolute -right-8 -top-8 w-24 h-24 flex items-center justify-center">
