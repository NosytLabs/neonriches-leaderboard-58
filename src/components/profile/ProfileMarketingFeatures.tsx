...
import { Sparkles, TrendingUp, Users, Eye, BarChart, Share2, Crown, Target, Globe, LineChart } from 'lucide-react';
    ...
    <div className="space-y-6 animate-royal-entrance">
      <Card className="glass-morphism border-white/10 overflow-hidden">
        ...
        <CardHeader>
          ...
          <CardDescription>
            Turn your status spending into genuine marketing value - your profile is a powerful promotional tool.
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="glass-morphism-highlight rounded-lg p-4 my-4">
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  <Globe className="h-4 w-4 text-royal-gold mr-2 mt-1 flex-shrink-0" />
                  <div>
                    <p className="text-sm font-medium">Global Visibility</p>
                    <p className="text-xs text-white/70">
                      Higher ranked users get priority placement across the entire platform.
                      {user.rank <= 100 ? " You're currently in the top 100!" : ""}
                    </p>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/70">
                      {user.tier === 'premium' || user.tier === 'royal' ? 
                        ...
                        "Upgrade to Premium or Royal to unlock detailed analytics."}
                    </p>
                  </div>
                </div>
                
                <div className="flex items-start">
                  <Target className="h-4 w-4 text-royal-gold mr-2 mt-1 flex-shrink-0" />
                  <div>
                    <p className="text-sm font-medium">Target Audience</p>
                    <p className="text-xs text-white/70">
                      {user.tier === 'royal' ? 
                        "Access detailed visitor demographics and interests." : 
            ...
            {user.tier !== 'premium' && user.tier !== 'royal' && (
              <div className="relative rounded-lg border border-dashed border-royal-gold/40 p-4 animate-border-glow">
                <h4 className="font-semibold flex items-center">
                  ...
                  <span className="animate-text-shimmer">Unlock Marketing Power</span>
                </h4>
                <p className="text-sm text-white/70 mt-1 mb-3">
                  ...
                  marketing platform with analytics, custom branding, and priority visibility.
                </p>
                <Button 
                  onClick={onBoostProfile}
                  variant="outline" 
