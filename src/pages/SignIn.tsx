  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-background p-4">
      <Card className="w-full max-w-md glass-morphism border-white/10">
        <CardHeader>
          <CardTitle className="text-2xl text-center royal-gradient">Royal Court Access</CardTitle>
        ...
        <CardContent className="space-y-4">
          <p className="text-center text-white/70">
            Sign in functionality is currently being built by the royal engineers.
          </p>
