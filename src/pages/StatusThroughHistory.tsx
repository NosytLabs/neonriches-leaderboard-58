    ...
    <>
      ...
      <Container className="py-16 relative">
        <div className="relative max-w-6xl mx-auto">
          ...
          <RoyalDivider variant="crown" label="THE PSYCHOLOGY OF STATUS" color="gold" className="mb-8" />
          ...
          <div className="prose prose-invert max-w-none mb-16">
            ...
            <p className="text-xl leading-relaxed text-white/80">
              ...
              From Roman equestrian ranks to Twitter blue checks, the mechanisms change while the underlying psychology remains constant.
            </p>
          </div>
          
          {/* Era Tabs */}
          <RoyalDivider variant="crown" label="HISTORICAL ERAS" color="gold" className="mb-8" />
          
          <Tabs defaultValue="ancient" className="mb-16">
            <TabsList className="mb-6 grid w-full grid-cols-4">
              <TabsTrigger value="ancient" className="text-lg">Ancient</TabsTrigger>
              <TabsTrigger value="medieval" className="text-lg">Medieval</TabsTrigger>
              <TabsTrigger value="victorian" className="text-lg">Gilded Age</TabsTrigger>
              <TabsTrigger value="modern" className="text-lg">Modern</TabsTrigger>
            </TabsList>
            
            {historicalData.map((period, index) => (
              <TabsContent key={index} value={period.era.toLowerCase().split(' ')[0]}>
                <div className="mb-8">
                  <h2 className="text-3xl font-bold royal-text mb-4">
          ...
          <RoyalDivider variant="crown" label="THE PHILOSOPHY OF STATUS" color="gold" className="mb-8" />
