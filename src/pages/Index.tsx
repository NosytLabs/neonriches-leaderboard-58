        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          <div className="text-center mb-16 pt-24">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-6">
              <Link to="/leaderboard">
                <Button 
                  size="lg" 
                  className="bg-gradient-to-r from-royal-gold to-amber-500 text-black hover:opacity-90 text-lg font-bold"
                >
          ...
          <div className="glass-morphism border-royal-gold/30 p-8 rounded-lg text-center max-w-3xl mx-auto mb-16">
            ...
            <Link to="/signup">
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-royal-gold to-amber-500 text-black hover:opacity-90"
              >
