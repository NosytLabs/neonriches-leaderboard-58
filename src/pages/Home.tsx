...
import { ArrowRight, Crown, Trophy, Users, Heart, Coins, Swords, Star, Gem, Sparkles } from 'lucide-react';
...
import EnhancedWishingWell from '@/components/wishingwell/EnhancedWishingWell';
  ...
  return (
    <Shell className="relative">
      ...
      <div className="flex flex-col gap-8 max-w-7xl mx-auto">
        {/* Hero section */}
        <div className="relative w-full rounded-lg overflow-hidden py-16">
          <div className="absolute inset-0 bg-black/20 backdrop-blur-sm rounded-lg z-0"></div>
          
          <div className="relative z-10 flex flex-col items-center py-8 px-6 text-center">
            <div className="mb-8 animate-float">
              <ThroneChair size="lg" animate={true} />
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight royal-gradient mb-4 font-medieval">
              SpendThrone
            </h1>
            ...
            {user ? (
              <Link to="/dashboard">
                <Button className="bg-royal-gold text-black hover:bg-royal-gold/90 royal-button-enhanced text-lg py-6 px-8">
        ...
        <div className="mt-12">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-medieval royal-gradient mb-2">
              The Royal Wishing Well
            </h2>
            <p className="text-white/80 max-w-3xl mx-auto">
              Cast thy coins into the mystical well and receive cosmetic treasures to embellish thy royal profile.
              Higher donations improve thy chances of receiving items of greater rarity.
            </p>
          </div>
        ...
        <div className="mt-12 mb-8">
          <div className="bg-gradient-to-r from-royal-crimson-dark to-royal-purple-dark rounded-lg p-8 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <Sparkles className="h-16 w-16 mx-auto text-royal-gold mb-4 animate-crown-glow" />
