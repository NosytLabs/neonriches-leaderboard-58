	...
	theme: {
		...
		extend: {
			colors: {
				...
				royal: {
					crimson: '#8B0000',    // Deep red for nobility
					gold: '#CFB53B',       // Antique gold
					navy: '#000080',       // Royal blue
					purple: '#4B0082',     // Royal purple
					bronze: '#CD7F32',     // Bronze for accents
					parchment: '#F5DEB3',  // Light background
					ink: '#1A1A1A',        // Dark text
				  },
				  team: {
					red: '#8B0000',    // Matches royal.crimson
					green: '#CFB53B',  // Matches royal.gold
					blue: '#000080',   // Matches royal.navy
				  },
			},
			borderRadius: {
				lg: 'var(--radius)',
